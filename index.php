...
<body>
    ...
    <footer class="footer">
        <div class="container">
            <p>
                &copy; <?= date('Y') ?> CanCanBook. All rights reserved.
                <a href="https://github.com" target="_blank" rel="noopener noreferrer" aria-label="GitHub" style="margin-left: 12px; display: inline-flex; vertical-align: middle;">
